...
import com.example.demo.models.MyProduct;
import com.example.demo.models.MyUser;
import com.example.demo.pojo.MyOrderDto;
import com.example.demo.pojo.MyProductDto;
import com.example.demo.pojo.MyUserDto;
import com.example.demo.pojo.ResponseDto;
import com.example.demo.repositories.MyOrderRepository;
import com.example.demo.repositories.MyProductRepository;
...
public class MyTestController {
    ...
    String saveProduct(@RequestBody MyProductDto myProductDto) {
        ...
        myProduct.setDescription(myProductDto.getDescription());
        myProductRepository.save(myProduct);
        return "success";
    }

    @GetMapping("/product/delete")
    String deleteProduct(@RequestParam(name = "id") Long id) {
